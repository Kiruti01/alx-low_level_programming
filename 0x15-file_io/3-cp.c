 ...
 * Return: pointer to newly-given buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
 ...
 * @argc: The num of args supplied to program.
 * @argv: An array of pointers to the args.
 * Return: success(0).
 * Descript: If argument incorrect - exit code 97.
 * If file_from does not exist - exit code 98.
 * If file_to cannot be created or wrtten - exit code 99.
